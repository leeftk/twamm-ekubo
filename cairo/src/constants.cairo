...
const TOKEN_BRIDGE_MAPPING: [(felt252, felt252); 6] = [
    (L1_ETH_ADDRESS, L2_ETH_BRIDGE), (L1_STRK_ADDRESS, L2_STRK_BRIDGE),
    (L1_USDC_ADDRESS, L2_USDC_BRIDGE), (L1_USDT_ADDRESS, L2_USDT_BRIDGE),
    (L1_WBTC_ADDRESS, L2_WBTC_BRIDGE), (L1_WSTETH_ADDRESS, L2_WSTETH_BRIDGE),
];
