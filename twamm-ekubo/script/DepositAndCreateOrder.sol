...
contract DepositAndCreateOrder is Script {
    function run() public {
        ...
        // );
        address bridgeAddress = 0x67B7A14745F14C253Beb5d44b767ef1BFB916253;
        uint256 l2EndpointAddress = uint256(
            0x05384d7aa25d47c73d60f2ee889af6b337544c534b05d8560578c06f01db55bd
        );
        ...
        //     542
        // );
        // IL1TWAMMBridge(bridgeAddress).setL2EndpointAddress(0x05384d7aa25d47c73d60f2ee889af6b337544c534b05d8560578c06f01db55bd);
